...
import { SemesterResponseDTO, UpdateSemesterDTO } from 'src/semesters/SemesterDTO';
import { CourseRepository } from 'src/courses/course.repository';
import { SubjectRepository } from 'src/subjects/subject.repository';
import { CourseResponseDTO } from 'src/courses/CourseDTO';
import { SubjectResponseDTO } from 'src/subjects/SubjectDTO';
